...
export class Hive extends Events {
    constructor( url ) {
        super();
        this.url = url;
        this.vehicles = {};
    ...
    _onVehiclesUpdated( msg ) {
        ...
        this.trigger( 'update:vehicles', this.vehicles );
    }

    _onPositionsUpdated( msg ) {
        this.positions = msg.data;
        this.trigger( 'update:positions', this.positions );
    }
